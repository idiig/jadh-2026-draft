...
#+name: fig:anchor
[[../images/fig2-anchor-encoding.svg]]
...
#+caption: Qwen2.5-assisted translation-based kugire suggestion with the first poem and Kaneko's explanatory translation as an example. The model's proposed position is corrected by human review.
#+name: fig:annotation-pipeline
[[../images/fig-annotation-pipeline.svg]]

The figure uses a romanized transcription and English gloss for legibility. The corresponding poem is =年の内に／春はきにけり／ひとゝせを／こそとやいはむ／ことしとやいはむ=; Kaneko's translation is =年内に思い掛けず春は来たことであるわ、さてはこの同じ一年の内の昨日までを、去年と言おうか、それとも今年と言おうか。=
