...
#heading(level: 1)[Data sources] #label("orga362fcf")
#heading(level: 2)[Base data] #label("org5eec2e8")
The base data is a lexically extended version of the TEI data of the Karoku second\u{2d}year manuscript of the Kokinwakashu #link(label("org22e4e49"))[[4]]. The extended dataset maps tokenization from the Hachidaishu Vocabulary Dataset #link(label("orgf212490"))[[5]] onto this segmented text, forming the basis for the kugire annotation.
#heading(level: 2)[Reference data] #label("org8b75841")
For the rule\u{2d}based method, we use the Hachidaishu Part\u{2d}of\u{2d}Speech Dataset #link(label("org5651e1f"))[[6]], which provides conjugation and part\u{2d}of\u{2d}speech data for each token. For the translation\u{2d}based method, we use the explanatory translation of the Kokinwakashu by #link(label("orgc8588fa"))[[7]], the earliest twentieth\u{2d}century explanatory translation of the anthology, digitized and published on Zenodo #link(label("orgbeea150"))[[8]].
#heading(level: 1)[Output Data] #label("org86c106b")
...
explanatory translation #link(label("orgc8588fa"))[[7]], identifies
...
#heading(level: 1)[Annotation pipeline] #label("orgef290d7")
The annotation follows an LLM\u{2d}assisted pipeline:

#enum(enum.item(1)[Rule\u{2d}based suggestion of candidate kugire positions based on #link(label("org5651e1f"))[[6]]],
enum.item(2)[LLM\u{2d}assisted translation\u{2d}based suggestion of candidate kugire positions based on #link(label("orgc8588fa"))[[7]], #link(label("orgbeea150"))[[8]]],
...
#heading(level: 2)[Rule\u{2d}based (grammar\u{2d}wise) kugire suggestion] #label("org3d7c7fa")
...
Strong candidates are phrases ending in the conclusive form. For example, in the first poem of the Kokinwakashu, the past\u{2d}tense auxiliary verb #emph[keri] appears in the conclusive form, indicating a grammatical break after it (#ref(label("org126df6e"))\u{2d}(1)).

#figure([#image(sys.inputs.file-0, width: 100%)]) #label("org126df6e")

Moderate candidates are phrases where the copula or information structure suggests a break, though not conclusively. In the second poem of the Kokinwakashu, the segments before and after #raw("wo") are syntactically connected, yet the former presents a scene while the latter offers a conjectural statement about it — a shift that may indicate a break (#ref(label("org126df6e"))\u{2d}(2)).

Weak candidates are phrases where a sentence\u{2d}final particle suggests a break, but the surrounding segments remain semantically interdependent. In the third poem of the Kokinwakashu, the question particle in the second segment may suggest a break, yet the following segment answers that question — semantic interdependence that makes the break uncertain (#ref(label("org126df6e"))\u{2d}(3)).
#heading(level: 2)[LLM\u{2d}assisted translation\u{2d}based kugire suggestion] #label("org694e484")
...
#heading(level: 1)[Conculusion] #label("org72464df")
...
#heading(level: 1)[References] #label("orgf398ad1")
 [1] #label("org0b717e8") H. Kami, “Shin\u{2d}Kokin ni Okeru Sankugire no Hyogen Kozo\u{2f}The Expressive Structure of Third\u{2d}Line Breaks in the Shin\u{2d}Kokinshū [新古今における三句切れの表現構造],” #emph[Bunkyo Daigaku Joshi Tandai\u{2d}bu Kenkyu Kiyo\u{2f}Bunkyo University Women’s Junior College Research Bulletin], vol. 29, pp. 10–23, Dec. 1985.

 [2] #label("org5b924d6") J. Asaoka, “Waka ni Okeru Bun no Kosei: Heian Waka no Tenkanki ni Kansuru Ichi Kosatsu\u{2f}Sentence Structure in Waka: A Study on the Transitional Period of Heian Waka [和歌における文の構成―平安和歌の転換期に関する一考察―],” #emph[Nishogakusha Daigaku Jinbun Ronsoˉ\u{2f}Nishogakusha University Journal of Humanities], vol. 81, pp. 130–140, Oct. 2008.

 [3] #label("org4560004") J. Asaoka, “Waka no Kugire ni Kansuru Ichi Kosatsu: Atarashii Nintei Kijun Shian no Koso\u{2f}A Study on Kugire in Waka: Toward a New Proposal for Recognition Criteria [和歌の句切れに関する一考察 : 新しい認定基準私案の構想],” #emph[Nishogakusha Daigaku Jinbun Ronsoˉ\u{2f}Nishogakusha University Journal of Humanities], vol. 78, pp. 113–122, Mar. 2007.

 [4] #label("org22e4e49") H. Ikuura, K. Nagasaki, and Y. Kato, “Chokusen Wakashu no Kozo\u{2d}ka to Teiji Shuho ni Kansuru Kokoromi: Karoku Ninenhon Kokinwakashu wo Jirei to shite\u{2f}An Attempt at Structuring and Presenting Imperial Waka Anthologies: The Karoku Second\u{2d}Year Manuscript of the Kokinwakashu as a Case Study [勅撰和歌集の構造化と提示手法に関する試み ―嘉禄二年本『古今和歌集』を事例として―],” in #emph[Proceedings of JINMONCOM 2023], Dec. 2023, vol. 2023, pp. 183–190.

 [5] #label("orgf212490") B. Hodošček and H. Yamamoto, “Development of datasets of the Hachidaishū and tools for the understanding of the characteristics and historical evolution of classical Japanese poetic vocabulary.:,” 2022.

 [6] #label("org5651e1f") H. Yamamoto, B. Hodošček, and X. Chen, “Hachidaishu Part\u{2d}of\u{2d}Speech Dataset.” Zenodo, Oct. 16, 2024, doi: #link("https://doi.org/10.5281/zenodo.13940187")[10.5281\u{2f}zenodo.13940187] #footnote(link("https://doi.org/10.5281/zenodo.13940187")).

 [7] #label("orgc8588fa") Kaneko Motoomi 金子元臣, #emph[Kokinwakashu hyoshaku: Showa shimban\u{2f}An annotated kokinwakashu: The new Showa edition [古今和歌集評釈: 昭和新版]]. Tokyo: Meijishoin, 1933.

 [8] #label("orgbeea150") H. Yamamoto, B. Hodošček, and X. Chen, “Kokinwakashu Hyoshaku by Motoomi Kaneko translation sentence vocabulary dataset.” Zenodo, Oct. 16, 2024, doi: #link("https://doi.org/10.5281/zenodo.13942707")[10.5281\u{2f}zenodo.13942707] #footnote(link("https://doi.org/10.5281/zenodo.13942707")).
