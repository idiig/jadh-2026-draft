...
#heading(level: 1)[Data sources] #label("org08b1974")
#heading(level: 2)[Base data] #label("orgeaae0e4")
The base data is a lexically extended version of the TEI data of the Karoku second\u{2d}year manuscript of the Kokinwakashu #link(label("org12f7045"))[[4]]. The extended dataset maps tokenization from the Hachidaishu Vocabulary Dataset #link(label("orgafebeb1"))[[5]] onto this segmented text, forming the basis for the kugire annotation.
#heading(level: 2)[Reference data] #label("org1c8ed67")
For the rule\u{2d}based method, we use the Hachidaishu Part\u{2d}of\u{2d}Speech Dataset #link(label("org573878b"))[[6]], which provides conjugation and part\u{2d}of\u{2d}speech data for each token. For the translation\u{2d}based method, we use the explanatory translation of the Kokinwakashu by #link(label("org5aea39f"))[[7]], the earliest twentieth\u{2d}century explanatory translation of the anthology, digitized and published on Zenodo #link(label("orgfd89ffa"))[[8]].
#heading(level: 1)[Output Data] #label("orgd6a36c0")
...
explanatory translation #link(label("org5aea39f"))[[7]], identifies
...
#heading(level: 1)[Annotation pipeline] #label("orgeace8aa")
The annotation follows an LLM\u{2d}assisted pipeline:

#enum(enum.item(1)[Rule\u{2d}based suggestion of candidate kugire positions based on #link(label("org573878b"))[[6]]],
enum.item(2)[LLM\u{2d}assisted translation\u{2d}based suggestion of candidate kugire positions based on #link(label("org5aea39f"))[[7]], #link(label("orgfd89ffa"))[[8]]],
...
#heading(level: 2)[Rule\u{2d}based (grammar\u{2d}wise) kugire suggestion] #label("orgbb00ff4")
...
Strong candidates are phrases ending in the conclusive form. For example, in the first poem of the Kokinwakashu, the past\u{2d}tense auxiliary verb #emph[keri] appears in the conclusive form, indicating a grammatical break after it (#ref(label("org72a0150"))\u{2d}(1)).

#figure([#image(sys.inputs.file-0, width: 100%)]) #label("org72a0150")

Moderate candidates are phrases where the copula or information structure suggests a break, though not conclusively. In the second poem of the Kokinwakashu, the segments before and after #raw("wo") are syntactically connected, yet the former presents a scene while the latter offers a conjectural statement about it — a shift that may indicate a break (#ref(label("org72a0150"))\u{2d}(2)).

Weak candidates are phrases where a sentence\u{2d}final particle suggests a break, but the surrounding segments remain semantically interdependent. In the third poem of the Kokinwakashu, the question particle in the second segment may suggest a break, yet the following segment answers that question — semantic interdependence that makes the break uncertain (#ref(label("org72a0150"))\u{2d}(3)).
#heading(level: 2)[LLM\u{2d}assisted translation\u{2d}based kugire suggestion] #label("orgdf2e109")
...
#heading(level: 1)[Conculusion] #label("org2151fcb")
...
#heading(level: 1)[References] #label("orgebadfa0")
 [1] #label("org5d59a14") 紙 宏行, “新古今における三句切れの表現構造,” #emph[文教大女子短大部研究紀要], vol. 29, pp. 10–23, Dec. 1985.

 [2] #label("org69c0190") 浅岡 純朗, “和歌における文の構成―平安和歌の転換期に関する一考察―,” #emph[二松学舎大学人文論叢], vol. 81, pp. 130–140, Oct. 2008.

 [3] #label("org0623120") 浅岡 純朗, “和歌の句切れに関する一考察 : 新しい認定基準私案の構想,” #emph[二松学舎大学人文論叢], vol. 78, pp. 113–122, Mar. 2007.

 [4] #label("org12f7045") 幾浦 裕之, 永崎 研宣, and 加藤 弓枝, “勅撰和歌集の構造化と提示手法に関する試み ―嘉禄二年本『古今和歌集』を事例として―,” #emph[じんもんこん2023論文集], vol. 2023, pp. 183–190, Dec. 2023.

 [5] #label("orgafebeb1") B. Hodošček and H. Yamamoto, “Development of datasets of the Hachidaishū and tools for the understanding of the characteristics and historical evolution of classical Japanese poetic vocabulary.:,” 2022.

 [6] #label("org573878b") H. Yamamoto, B. Hodošček, and X. Chen, “Hachidaishu Part\u{2d}of\u{2d}Speech Dataset.” Zenodo, Oct. 16, 2024, doi: #link("https://doi.org/10.5281/zenodo.13940187")[10.5281\u{2f}zenodo.13940187] #footnote(link("https://doi.org/10.5281/zenodo.13940187")).

 [7] #label("org5aea39f") Kaneko Motoomi 金子元臣, #emph[Kokinwakashu hyoshaku: Showa shimban\u{2f}An annotated kokinwakashu: The new Showa edition [古今和歌集評釈: 昭和新版]]. Tokyo: Meijishoin, 1933.

 [8] #label("orgfd89ffa") H. Yamamoto, B. Hodošček, and X. Chen, “Kokinwakashu Hyoshaku by Motoomi Kaneko translation sentence vocabulary dataset.” Zenodo, Oct. 16, 2024, doi: #link("https://doi.org/10.5281/zenodo.13942707")[10.5281\u{2f}zenodo.13942707] #footnote(link("https://doi.org/10.5281/zenodo.13942707")).
